...
type KafkaAdapterOld struct {
	reader *kafka.Reader
	writer *kafka.Writer
}

func NewKafkaAdapterOld() *KafkaAdapterOld {
...
func (adapter *KafkaAdapterOld) ReadMessage() (string, error) {
...
func (adapter *KafkaAdapterOld) WriteMessage(message []byte) error {
...
func (adapter *KafkaAdapterOld) Close() {
